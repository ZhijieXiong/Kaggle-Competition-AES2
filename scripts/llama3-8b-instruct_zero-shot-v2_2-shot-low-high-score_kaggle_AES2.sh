...

{
  CUDA_VISIBLE_DEVICES=4 torchrun --nproc_per_node 1  /home/xiongzj/myProjects/kaggle-AES2-competition/ask_local_llm.py \
    --prompt_type "few_shot" --zero_shot_type "zero_shot_v2" --example_type "2_shot_low_high_score" \
...
} >> /home/xiongzj/myProjects/kaggle-AES2-competition/results/llama3-8b-instruct_zero-shot-v2_2-shot-low-high-score_kaggle-AES2024.txt
