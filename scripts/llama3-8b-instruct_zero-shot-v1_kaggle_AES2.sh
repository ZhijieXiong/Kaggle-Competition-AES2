...

{
  CUDA_VISIBLE_DEVICES=4 torchrun --nproc_per_node 1  /home/xiongzj/myProjects/kaggle-AES2-competition/ask_local_llm.py \
    --prompt_type "zero_shot" --zero_shot_type "zero_shot_v1" --example_type "1_shot_low_score" \
...
} >> /home/xiongzj/myProjects/kaggle-AES2-competition/results/llama3-8b-instruct_zero-shot-v1_kaggle-AES2024.txt
