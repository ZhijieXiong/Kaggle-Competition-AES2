...
{
  CUDA_VISIBLE_DEVICES=5 python /home/xiongzj/myProjects/kaggle-AES2-competition/bert_classifier_train.py \
    ...
    --epsilon 0.000001 \
    --warmup_steps 0
} >> /home/xiongzj/myProjects/kaggle-AES2-competition/results/bert-classifier-uncased-max-pooling_kaggle-AES2024_only-valid_seed-42.txt
