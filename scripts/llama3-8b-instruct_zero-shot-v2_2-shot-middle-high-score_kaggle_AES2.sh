...

{
  CUDA_VISIBLE_DEVICES=4 torchrun --nproc_per_node 1  /home/xiongzj/myProjects/kaggle-AES2-competition/ask_local_llm.py \
    --prompt_type "few_shot" --zero_shot_type "zero_shot_v2" --example_type "2_shot_middle_high_score" \
    ...
    --temperature 0.6 --top_p 0.9 --max_seq_len 12288 --max_batch_size 4
} >> /home/xiongzj/myProjects/kaggle-AES2-competition/results/llama3-8b-instruct_zero-shot-v2_2-shot-middle-high-score_kaggle-AES2024.txt
